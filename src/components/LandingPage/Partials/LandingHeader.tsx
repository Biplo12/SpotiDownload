  ...
  return (
    <div className='flex flex-col items-center justify-center gap-4 text-white'>
      ...
      <p className='max-w-[1000px] text-center text-2xl'>
        ...
        <span className='font-bold text-[#1db954]'>Spotify</span> playlists as
        MP3 files for free. Just login with your Spotify account and paste the
        playlist link or choose one of your playlists. Then you can download the
        songs as MP3 files.
      </p>
    </div>
  );
